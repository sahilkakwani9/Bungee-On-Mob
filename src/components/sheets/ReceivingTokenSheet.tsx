...
const ReceivingTokenSheet = ({ sheetRef, data }: IReceivingChainSheet) => {
  const { setSelectedReceivingToken } = useConfigStore();
  const renderItem = ({ item }: { item: TokenInfo }) => {
    return (
      <TouchableOpacity
        style={styles.itemContainer}
        onPress={() => {
          setSelectedReceivingToken(item);
...
export default ReceivingTokenSheet;
